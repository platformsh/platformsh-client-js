...
import { EnvironmentTypeGetParams, EnvironmentTypeQueryParams, EnvironmentTypeAccessType } from "./types";
...
export default class EnvironmentType extends Ressource {
  id: string;
  accesses: Array<EnvironmentTypeAccessType>;
  ...
  constructor(environmentType: APIObject) {
    ...
    this.id = id;
    this.accesses = environmentType.access;
  }
