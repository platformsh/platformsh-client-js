...
import { IntegrationGetParams, IntegrationQueryParams, IntegrationType } from "./types";
...
export default class Integration extends autoImplementWithResources()<UnionToIntersection<IntegrationType>>() {
  id: string;
