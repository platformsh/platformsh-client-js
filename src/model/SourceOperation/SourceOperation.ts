...
import { SourceOperationQueryParams, SourceOperationType } from "./types";
...
export default class SourceOperation extends autoImplementWithResources()<SourceOperationType>() {
