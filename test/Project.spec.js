...
describe('Project', () => {
  ...
  it('Get environments', done => {
    fetchMock.mock('https://test.com/api/projects/ffzefzef3/environments?limit=2', [{id: 1}]);
    const project = new Project({
      _links: {
        environments: {
  ...
  it('Get domain', done => {
    fetchMock.mock('https://test.com/api/projects/ffzefzef3/domains/domainName', {
      id: 1,
      name: 'domainName'
    });
    const project = new Project({
  ...
  it('Add domain', done => {
    fetchMock.mock('https://test.com/api/projects/ffzefzef3/domains', {}, 'POST');
    const project = new Project({
      _links: {
        domains: {
          href: '/api/projects/ffzefzef3/domains'
  ...
  it('Get integrations', done => {
    fetchMock.mock('https://test.com/api/projects/ffzefzef3/integrations?limit=2', [{}]);
    const project = new Project({
      _links: {
        integrations: {
  ...
  it('Get activities', done => {
    const queryString = '?type=theType&starts_at=2017-03-21T09%3A06%3A30.550116%2B00%3A00';
    ...
    project.getActivities('theType', '2017-03-21T09:06:30.550116+00:00').then(activities => {
  ...
  it('Get variables', done => {
    fetchMock.mock('https://test.com/api/projects/ffzefzef3/variables?limit=1', [{
      id: 1,
  ...
  it('Get variable', done => {
    fetchMock.mock('https://test.com/api/projects/ffzefzef3/variables/theVariableName', {
      id: 1,
      name: 'theVariableName'
    });
    const project = new Project({
